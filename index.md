...
##### <sup>$+$</sup>denotes mentee, <sup>$\*$</sup> co-first authorship
...
J. Cable<sup>$+$</sup><sup>$\*$</sup>, D. Gregory<sup>$+$</sup><sup>$\*$</sup>, **L. Izhikevich<sup>$*$</sup>**, Z. Durumeric. [Stratosphere: Finding Vulnerable Cloud Storage Buckets](/assets/papers/stratosphere.pdf). In Proceedings of the 24th ACM International Symposium on Research in Attacks, Intrusions and Defenses (RAID), 2021. 
